...
export type OperatorCreateOpportunityInput = z.input<
  typeof OperatorCreateOpportunityInputSchema
>;

export type OperatorCreateOpportunityUseCase = UseCase<
  OperatorCreateOpportunityInput,
  OpportunityDetail,
  BaseError
>;
...
export const makeOperatorCreateOpportunityUseCase =
  (deps: {
    operatorRepository: OperatorRepository;
    opportunityCategoryRepository: OpportunityCategoryRepository;
    opportunityRepository: OpportunityRepository;
    placeRepository: PlaceRepository;
  }): OperatorCreateOpportunityUseCase =>
  async (input) =>
    validateUseCaseInput(OperatorCreateOpportunityInputSchema, input).andThen(
      (validatedInput) =>
        validateExistence({
