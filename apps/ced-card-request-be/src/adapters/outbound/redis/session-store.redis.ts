...
/**
 * Redis-backed FimsSessionStore for ced-card-request-be.
 *
 * All keys are namespaced with "card:" to avoid collisions with
 * ced-portal-be and ced-browser-be that share the same Redis instance.
 */
