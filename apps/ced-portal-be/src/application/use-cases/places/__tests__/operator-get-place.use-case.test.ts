...
import { makeOperatorGetPlaceUseCase } from "../operator-get-place.use-case.js";
import {
...
describe("makeOperatorGetPlaceUseCase", () => {
  it("should return the operator place when it exists", async () => {
    ...
    const useCase = makeOperatorGetPlaceUseCase(placeRepository);
