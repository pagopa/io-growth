...
const OperatorPublishOpportunityInputSchema = z.object({
  operatorId: z.ulid(),
  opportunityId: z.ulid(),
});

export type OperatorPublishOpportunityInput = z.infer<
  typeof OperatorPublishOpportunityInputSchema
>;

export type OperatorPublishOpportunityUseCase = UseCase<
  OperatorPublishOpportunityInput,
  void,
  | ConflictError
  | GenericError
  | NotFoundError
...
export const makeOperatorPublishOpportunityUseCase =
  (
    opportunityRepository: OpportunityRepository,
    materializedViewRepository: MaterializedViewRepository,
    profileRepository: ProfileRepository,
  ): OperatorPublishOpportunityUseCase =>
  async (input) =>
    validateUseCaseInput(OperatorPublishOpportunityInputSchema, input).andThen(
      (validatedInput) =>
        new ResultAsync(
