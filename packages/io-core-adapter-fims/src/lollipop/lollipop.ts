...
import type { FimsUser, LollipopHeaders } from "../domain/types.js";
 ...
 */
export const verifyLollipop = async (
  user: FimsUser,
  ...
  const stateResult = verifyStateInSignature(headers["signature-input"], state);
