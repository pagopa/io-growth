...
import { makeOperatorListOpportunitiesUseCase } from "../operator-list-opportunities.use-case.js";
...
describe("makeOperatorListOpportunitiesUseCase", () => {
  it("should return paginated opportunities", async () => {
    ...
    const useCase = makeOperatorListOpportunitiesUseCase(repository);
