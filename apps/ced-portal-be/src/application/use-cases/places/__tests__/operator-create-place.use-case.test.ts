...
import { makeOperatorCreatePlaceUseCase } from "../operator-create-place.use-case.js";
import { createMockPlaceRepository, mockCreatePlaceInput } from "./mocks.js";

describe("makeOperatorCreatePlaceUseCase", () => {
  it("should create an operator place", async () => {
    ...
    const useCase = makeOperatorCreatePlaceUseCase(placeRepository);
