...
| <a name="input_create_replica"></a> [create\_replica](#input\_create\_replica) | Whether to create a replica PostgreSQL Flexible Server. | `bool` | `false` | no |
...
| <a name="input_key_vault_id"></a> [key\_vault\_id](#input\_key\_vault\_id) | Key Vault ID for storing the admin password secret. | `string` | n/a | yes |
...
| <a name="input_storage_mb"></a> [storage\_mb](#input\_storage\_mb) | Maximum storage allowed in MB. | `number` | n/a | yes |
