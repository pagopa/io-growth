...
const SummaryStep = forwardRef<StepRef, SummaryProps>(function SummaryStep(
  ...
  return (
    <Fragment>
      <StepCard sx={{ mb: 3 }}>
        ...
        <VSpacer />
        <Body>
          Confermi, ai sensi degli artt. 46 e 47 del DPR n. 445/2000, che i dati
          inseriti e la documentazione allegata sono completi, veritieri e
          conformi alla documentazione in tuo possesso. Le dichiarazioni mendaci
          comportano le conseguenze previste dagli artt. 75 e 76 del DPR
          445/2000.
        </Body>
      </StepCard>
