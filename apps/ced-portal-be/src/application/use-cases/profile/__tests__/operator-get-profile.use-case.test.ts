...
import { makeOperatorGetProfileUseCase } from "../operator-get-profile.use-case.js";
import {
...
describe("makeOperatorGetProfileUseCase", () => {
  it("should return operator profile when profile exists", async () => {
    ...
    const useCase = makeOperatorGetProfileUseCase(profileRepository);
