...
import { makeOperatorPublishOpportunityUseCase } from "../operator-publish-opportunity.use-case.js";
import {
...
describe("makeOperatorPublishOpportunityUseCase - dateFrom refresh logic", () => {
  it("should publish and refresh views when dateFrom is in the past", async () => {
    ...
    const useCase = makeOperatorPublishOpportunityUseCase(
...
describe("makeOperatorPublishOpportunityUseCase - status guard", () => {
...
describe("makeOperatorPublishOpportunityUseCase - error propagation", () => {
...
describe("makeOperatorPublishOpportunityUseCase - input validation", () => {
